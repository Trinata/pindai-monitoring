...
--
-- Host: localhost
-- Generation Time: Nov 29, 2015 at 08:49 PM
...
INSERT INTO `ck_user_member` (`id`, `nik`, `name`, `username`, `email`, `password`, `register_date`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `pendidikan`, `institusi`, `jenis_pekerjaan`, `hp`, `alamat`, `hak_akses`, `other_data`, `type`, `salt`, `login_count`, `email_token`, `is_online`, `n_status`) VALUES
(1, '123', 'admin', 'admin', 'admin@admin.com', 'b2e982d12c95911b6abeacad24e256ff3fa47fdb', '2015-11-16 17:00:00', 1, NULL, '2015-11-02', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'codekir v3.0', 0, NULL, 0, 1);
